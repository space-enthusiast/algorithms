...
int main() {
    ...
    rating.insert({"tourist", 3858});
    rating.insert({"ksun48", 3679});
    rating.insert({"Benq", 3658});
    rating.insert({"Um_nik", 3648});
    rating.insert({"apiad", 3638});
    rating.insert({"Stonefeang", 3630});
    rating.insert({"ecnerwala", 3613});
    rating.insert({"mnbvmar", 3555});
    rating.insert({"newbiedmy", 3516});
    rating.insert({"semiexp", 3481});
